#!/bin/bash
cd /mnt/vagrant/lustre/source/lustre-$LUSTRE_VERSION/debian
echo Y | ./prepare.sh /vagrant/lustre/debs/linux-image-*
cd /mnt/vagrant/lustre/source/lustre-$LUSTRE_VERSION
...
rsync -a /mnt/vagrant/lustre/source/lustre-$LUSTRE_VERSION/*  /usr/src/lustre-client-modules-$LUSTRE_VERSION-1.0.0
